...
ann_file_train=info_root + f"nuscenes_infos_temporal_train_mini.pkl"
ann_file_val=info_root + f"nuscenes_infos_temporal_val_mini.pkl"
ann_file_test=info_root + f"nuscenes_infos_temporal_val_mini.pkl"
